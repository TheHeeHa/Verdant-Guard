const CACHE='verdant-guard-v26';
const CORE=['./','./index.html','./styles.css?v=20260815-1','./expansion.css?v=20260815-1','./game.js?v=20260815-1','./expansion.js?v=20260815-1','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
