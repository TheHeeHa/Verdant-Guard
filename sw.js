const CACHE='verdant-guard-v12';
const CORE=['./','./index.html','./styles.css?v=20260809-15','./game.js?v=20260809-18','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
