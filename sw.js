const CACHE='verdant-guard-v27';
const CORE=['./','./index.html','./styles.css?v=20260816-2','./expansion.css?v=20260816-2','./game.js?v=20260816-2','./expansion.js?v=20260816-2','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./gameplay.png'];
