const CACHE='verdant-guard-v24';
const CORE=['./','./index.html','./styles.css?v=20260811-7','./expansion.css?v=20260811-7','./game.js?v=20260811-7','./expansion.js?v=20260811-7','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
