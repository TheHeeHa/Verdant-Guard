const CACHE='verdant-guard-v6';
const CORE=['./','./index.html','./styles.css?v=20260809-12','./game.js?v=20260809-12','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
