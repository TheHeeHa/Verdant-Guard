const CACHE='verdant-guard-v29';
const CORE=['./','./index.html','./styles.css?v=20260817-1','./expansion.css?v=20260817-1','./game.js?v=20260817-1','./expansion.js?v=20260817-1','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./gameplay.png'];
