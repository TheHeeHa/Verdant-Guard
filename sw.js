const CACHE='verdant-guard-v34';
const CORE=['./','./index.html','./styles.css?v=20260818-2','./expansion.css?v=20260818-2','./game.js?v=20260818-2','./expansion.js?v=20260818-2','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./gameplay.png'];
