const CACHE='verdant-guard-v14';
const CORE=['./','./index.html','./styles.css?v=20260809-16','./game.js?v=20260809-20','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
