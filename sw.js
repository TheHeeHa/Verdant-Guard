const CACHE='verdant-guard-v36';
const CORE=['./','./index.html','./styles.css?v=20260818-4','./expansion.css?v=20260818-4','./game.js?v=20260818-4','./expansion.js?v=20260818-4','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./gameplay.png'];
