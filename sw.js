const CACHE='verdant-guard-v31';
const CORE=['./','./index.html','./styles.css?v=20260817-3','./expansion.css?v=20260817-3','./game.js?v=20260817-3','./expansion.js?v=20260817-3','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./gameplay.png'];
