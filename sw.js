const CACHE='verdant-guard-v1';
const CORE=['./','./index.html','./styles.css?v=20260802-8','./game.js?v=20260802-8','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
