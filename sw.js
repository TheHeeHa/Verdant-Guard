const CACHE='verdant-guard-v17';
const CORE=['./','./index.html','./styles.css?v=20260809-18','./game.js?v=20260809-22','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
