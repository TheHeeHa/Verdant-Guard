const CACHE='verdant-guard-v3';
const CORE=['./','./index.html','./styles.css?v=20260802-9','./game.js?v=20260802-10','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
