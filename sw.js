const CACHE='verdant-guard-v23';
const CORE=['./','./index.html','./styles.css?v=20260811-6','./game.js?v=20260811-6','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
