const CACHE='verdant-guard-v11';
const CORE=['./','./index.html','./styles.css?v=20260809-14','./game.js?v=20260809-17','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
