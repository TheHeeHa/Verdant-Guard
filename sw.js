const CACHE='verdant-guard-v33';
const CORE=['./','./index.html','./styles.css?v=20260818-1','./expansion.css?v=20260818-1','./game.js?v=20260818-1','./expansion.js?v=20260818-1','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./gameplay.png'];
