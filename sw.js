const CACHE='verdant-guard-v20';
const CORE=['./','./index.html','./styles.css?v=20260811-3','./game.js?v=20260811-3','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
