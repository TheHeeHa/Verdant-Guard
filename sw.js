const CACHE='verdant-guard-v8';
const CORE=['./','./index.html','./styles.css?v=20260809-13','./game.js?v=20260809-14','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
