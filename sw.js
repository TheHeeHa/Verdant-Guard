const CACHE='verdant-guard-v15';
const CORE=['./','./index.html','./styles.css?v=20260809-17','./game.js?v=20260809-21','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
