const CACHE='verdant-guard-v5';
const CORE=['./','./index.html','./styles.css?v=20260808-11','./game.js?v=20260808-11','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
