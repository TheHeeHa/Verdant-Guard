const CACHE='verdant-guard-v35';
const CORE=['./','./index.html','./styles.css?v=20260818-3','./expansion.css?v=20260818-3','./game.js?v=20260818-3','./expansion.js?v=20260818-3','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./gameplay.png'];
