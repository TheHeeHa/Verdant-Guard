...
![Verdant Guard gameplay showing the battlefield and tower build deck](gameplay.png)
...
- **Secret level:** Beat Void Garden to permanently reveal The Vanished Grove, where alternating halves of the battlefield phase out between waves. Its first victory awards 10 Stat Points, the Riftwalker title, the Voidgrown tower style, the Void Rift projectile trail, and the Nothing Stays Lost achievement.
- **Seasonal Maps:** Summer’s End contains Firefly Marsh (Seasonal Hard), Last Sunset Ridge (Seasonal Extreme), and Harvest Moon Grove (Seasonal Mythic). Their first-clear rewards are respectively the Firefly trail; the Last Light Guardian title plus Sunset Flare trail; and the Moon Harvest trail plus 15 Stat Points.
- **Projectile trails:** Collection includes None (the default) plus earnable Dewdrop, Leafspark, Moss Spores, Ember Wake, Starlight, Heartseed, Void Rift, Firefly, Sunset Flare, and Moon Harvest trails. Assign one to all tower types or override individual tower types. The verified owner automatically has every built-in and seasonal trail.
- **Battle weather:** Weather is gameplay-active. Rain slows enemies 8%; fog cuts tower range 12%; heat speeds enemies 10% but increases end-of-wave credits 15%; and night increases tower damage 8% while speeding enemies 5%.
